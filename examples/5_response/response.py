...
# Created Time: 一  3/ 6 12:58:52 2017
# coding=utf-8
## Last Modified : 一  3 06 14:30:39 2017
...
# encoded with `utf-8` codec )(charset set accordingly)
def text(request):
...
def encoding(request):
    return request.Response(text='Ja pronto!', encoding='iso-8859-1')
...
def body(request):
    return request.Response(body=b'\xde\xad\be\xef')
